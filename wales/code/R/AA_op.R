...
condition_prefix="AA_op"
dataspec_prefix="Aortic_aneurysm_procedures"
top_dir="../.."
...
codes=c("L18","L19","L20","L21","L22","L23","L25","L26","L27","L28")
names(codes)=rep("AA_repair",length(codes))
...
dat$hier_1=0
dat[dat$OPER_CD_123 %in% c("L18", "L19", "L20", "L21", "L22", "L23", "L25"),]$"hier_1"=1
dat[dat$OPER_CD_123 %in% c("L26", "L27", "L28"),]$"hier_1"=2
...
#            last_ep_d1_h2=first(na.omit(last_episode_first_oper_hier_2,)),
            ...
            AA_repair=as.integer(any(AA_repair==1))
