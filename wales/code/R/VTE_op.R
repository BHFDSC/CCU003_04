...
condition_prefix="VTE_op"
dataspec_prefix="VTE procedures"
top_dir="../.."
...
#Special case where all codes are required 
dat$VTE_pae=1
...
dat$hier_1=0
dat[dat$OPER_CD %in% c("L124", "L125"),]$"hier_1"=1
dat[dat$OPER_CD_123 %in% c("L13"),]$"hier_1"=2
