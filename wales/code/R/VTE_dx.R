...
condition_prefix="VTE_dx"
dataspec_prefix="VTE dx spec"
top_dir="../.."
...
for (code in codes){
  if (TRUE %in% (startsWith(dat$DIAG_CD,code))){ #If this code is present somewhere
    
    dat[startsWith(dat$DIAG_CD,code),]$"hier_1"=1 #Then set the hierarchy for it 
...
for (code in codes){
  if (TRUE %in% (startsWith(dat$DIAG_CD,code))){ #If this code is present somewhere
    ...
    dat[startsWith(dat$DIAG_CD,code),]$"hier_1"=2 #Then set the hierarchy for it 
...
for (code in codes){
  if (TRUE %in% (startsWith(dat$DIAG_CD,code))){ #If this code is present somewhere
    ...
    dat[startsWith(dat$DIAG_CD,code),]$"hier_1"=3 #Then set the hierarchy for it 
...
for (code in codes){
  if (TRUE %in% (startsWith(dat$DIAG_CD,code))){ #If this code is present somewhere
    ...
    dat[startsWith(dat$DIAG_CD,code),]$"hier_1"=4 #Then set the hierarchy for it 
