...
condition_prefix="Stroke_dx"
condition_prefix_op="Stroke_op" #Need to define this here as stroke procedures need diag and proc data
dataspec_prefix="Acute_stroke_dx"
top_dir="../.."
eclipse_dir=file.path(top_dir,"data","eclipse","diagnoses")
eclipse_dir_op=file.path(top_dir,"data","eclipse","procedures")
...
input_file_diags=file.path(eclipse_dir,csv_files[rev(order(file.info(file.path(eclipse_dir,csv_files))$ctime))][1])

#Repeat for procs
csv_files=list.files(eclipse_dir_op)[endsWith(list.files(eclipse_dir_op),".csv")]
csv_files=csv_files[grepl(condition_prefix_op,csv_files)]
input_file_opers=file.path(eclipse_dir_op,csv_files[rev(order(file.info(file.path(eclipse_dir_op,csv_files))$ctime))][1])

#Open both of these, and then concatenate them
dat_opers=read.csv(input_file_opers)
dat_diags=read.csv(input_file_diags)
#Add in the 123 codes here
dat_opers["OPER_CD_123"]=substr(dat_opers$OPER_CD,0,3)
dat_diags["DIAG_CD_123"]=substr(dat_diags$DIAG_CD,0,3)

dat=plyr::rbind.fill(dat_opers,dat_diags)
...
output_file=file.path(top_dir,"data","combine",paste0(condition_prefix_op,".csv"))
...
#Special stroke-only code
dat =
  dat %>%
  group_by(SPELL_NUM_E,PROV_UNIT_CD,EPI_NUM) %>% #Group by spell 
  filter("I63" %in% OPER_CD_123 & "X833" %in% OPER_CD | #Then filter for those records that have specific combinations of codes 
         "I63" %in% DIAG_CD_123 & "X833" %in% OPER_CD |
         "I63" %in% OPER_CD_123 & "X833" %in% DIAG_CD |
         "I63" %in% DIAG_CD_123 & "X833" %in% DIAG_CD |
           
         "I63" %in% OPER_CD_123 & "L354" %in% OPER_CD | 
         "I63" %in% DIAG_CD_123 & "L354" %in% OPER_CD |
         "I63" %in% OPER_CD_123 & "L354" %in% DIAG_CD |
         "I63" %in% DIAG_CD_123 & "L354" %in% DIAG_CD |
       
       
         "O01" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 | 
         "O01" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 |
         "O01" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 |
         "O01" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 | 
         "O01" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O01" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O01" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O01" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123 |
       
         "O02" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 | 
         "O02" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 |
         "O02" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 |
         "O02" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 | 
         "O02" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O02" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O02" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O02" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123 |        
       
         "O03" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 | 
         "O03" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 |
         "O03" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 |
         "O03" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 | 
         "O03" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O03" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O03" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O03" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123 |
         
         "O04" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 | 
         "O04" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 |
         "O04" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 |
         "O04" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 | 
         "O04" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O04" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O04" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
         "O04" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123 |   
...
#Stroke is always unique


dat = dat %>%  mutate(stroke_st=ifelse("I63" %in% OPER_CD_123 & "X833" %in% OPER_CD | 
                                   "I63" %in% DIAG_CD_123 & "X833" %in% OPER_CD |
                                   "I63" %in% OPER_CD_123 & "X833" %in% DIAG_CD |
                                   "I63" %in% DIAG_CD_123 & "X833" %in% DIAG_CD |
                                   ...
                                   "I63" %in% DIAG_CD_123 & "L354" %in% OPER_CD |
                                   "I63" %in% OPER_CD_123 & "L354" %in% DIAG_CD |
                                   "I63" %in% DIAG_CD_123 & "L354" %in% DIAG_CD, 1,0),
                
                stroke_cac=ifelse("O01" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 | 
                                    "O01" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% OPER_CD_123 |
                                    "O01" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 |
                                    "O01" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% OPER_CD_123 | 
                                    "O01" %in% OPER_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
                                    ...
                                    "O04" %in% OPER_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123 |
                                    "O04" %in% DIAG_CD_123 & "Y53" %in% OPER_CD_123 & "Z35" %in% DIAG_CD_123 |
                                    "O04" %in% DIAG_CD_123 & "Y53" %in% DIAG_CD_123 & "Z35" %in% DIAG_CD_123,1,0),
                
                
                stroke_ces = ifelse("L294" %in% DIAG_CD |
                                     "L294" %in% OPER_CD |
                                     "L295" %in% DIAG_CD |
                                     "L295" %in% OPER_CD |         
                                     "L314" %in% DIAG_CD |
                                     "L314" %in% OPER_CD,1,0) ) %>% 
  # select(-c("DIAG_CD","DIAG_CD_123","DIAG_NUM")) %>% 
  drop_na(OPER_CD) %>%   #We can drop the dead columns in OPER_CD and still keep the same spells
  ungroup()
...
#Create diag codes manually
dat$DIAG_CD_123 = substr(dat$DIAG_CD, 0, 3)

#Check diagnoses for the first hierarchy
dat$hier_1=0
dat[dat$DIAG_CD_123 %in% c("I60", "I61", "I63", "I64"),]$"hier_1"=1
dat[dat$DIAG_CD_123 %in% c("G45"),]$"hier_1"=2

#Group data by episode and get highest hierarchy for that whole episode
dat = dat %>% 
  group_by(SPELL_NUM_E,PROV_UNIT_CD,EPI_NUM) %>% 
  mutate(episode_hier_1=max(hier_1))
...
dat = dat %>% 
  group_by(SPELL_NUM_E,PROV_UNIT_CD,EPI_NUM) %>%  
  mutate(last_episode_hier_1=case_when(lastepisodeinspell==TRUE ~ max(hier_1),
                                       TRUE ~ NA_real_),
...
dat_spell = 
  ...
  summarize(patient_number=first(PAT_ID_E),#Patient number
            ...
            stroke_st=as.integer(any(stroke_st==1)),
            stroke_ces=as.integer(any(stroke_ces==1)),
            stroke_cac=as.integer(any(stroke_cac==1))
