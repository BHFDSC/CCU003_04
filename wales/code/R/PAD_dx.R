...
condition_prefix="PAD_dx"
dataspec_prefix="Peripheral arterial disease_dx"
top_dir="../.."
...
dat$hier_1=0
dat[startsWith(dat$DIAG_CD,"I74"),]$"hier_1"=1
dat[startsWith(dat$DIAG_CD,"I70"),]$"hier_1"=2
dat[startsWith(dat$DIAG_CD,"I73"),]$"hier_1"=3
dat[startsWith(dat$DIAG_CD,"I77"),]$"hier_1"=4
