...
(--derived columns episodes table for ITU admission
  ...
  FROM .ccu003_04_nh_temp_final_episodes1 WHERE ITU_Admission > 0 GROUP BY PERSON_ID, SPELL_ID
...
DROP TABLE IF EXISTS .ccu003_04_nh_final_hf_admissions_op

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_nh_final_hf_admissions_op AS 
...
ALTER TABLE .ccu003_04_nh_final_hf_admissions_op OWNER TO `nick.hall@dph.ox.ac.uk`

-- COMMAND ----------

select * from .ccu003_04_nh_final_hf_admissions_op

-- COMMAND ----------

select count(*) from .ccu003_04_nh_final_hf_admissions_op

-- COMMAND ----------

select count(distinct PERSON_ID) from .ccu003_04_nh_final_hf_admissions_op

-- COMMAND ----------

select count(*) from .ccu003_nh_final_hf_admissions_op

-- COMMAND ----------

select count(*) from .ccu003_04_nh_final_hf_admissions_dx

-- COMMAND ----------

select count(*) from .ccu003_nh_final_hf_admissions_dx
