...
(--derived columns episodes table for ITU admission
  ...
  FROM dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_final_episodes WHERE ITU_Admission > 0 GROUP BY PERSON_ID, SPELL_ID
...
select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_superspells_base ORDER BY PERSON_ID, SpellOrder
...
select * FROM dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_final_spells
...
select year(admidate), count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_hf_admissions_op_old group by year(admidate) order by year(admidate)
