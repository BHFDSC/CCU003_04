...
select max(disdate) from dars_nic_391419_j3w9t_collab.ccu003_04_base_nh
...
(--derived columns episodes table for ITU admission
  ...
  FROM dars_nic_391419_j3w9t_collab.ccu003_04_nh_temp_final_episodes1 WHERE ITU_Admission > 0 GROUP BY PERSON_ID, SPELL_ID
...
DROP TABLE IF EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_hf_admissions_op

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_hf_admissions_op AS 
...
ALTER TABLE dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_hf_admissions_op OWNER TO `nick.hall@dph.ox.ac.uk`

-- COMMAND ----------

select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_hf_admissions_op

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_hf_admissions_op

-- COMMAND ----------

select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_hf_admissions_op

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_nh_final_hf_admissions_op

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_hf_admissions_dx

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_nh_final_hf_admissions_dx
