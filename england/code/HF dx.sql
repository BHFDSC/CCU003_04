...
DROP TABLE IF EXISTS .ccu003_04_nh_final_hf_admissions_dx

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_nh_final_hf_admissions_dx AS 
...
ALTER TABLE .ccu003_04_nh_final_hf_admissions_dx OWNER TO `nick.hall@dph.ox.ac.uk`

-- COMMAND ----------

select * from .ccu003_04_nh_final_hf_admissions_dx
...
select count(distinct PERSON_ID) from .ccu003_04_nh_final_hf_admissions_dx
