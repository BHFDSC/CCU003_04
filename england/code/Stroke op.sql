...
DROP TABLE IF EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op_v1

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op_v1 AS 
...
select * from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op_v1

-- COMMAND ----------

refresh table dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op_v1

-- COMMAND ----------

select count(distinct SPELL_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op

-- COMMAND ----------

select count(distinct SPELL_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op_v1

-- COMMAND ----------

select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op

-- COMMAND ----------

select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op_v1

-- COMMAND ----------

select * from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_dx_v1 where person_id = '09T80C90ZOFDJDD'

-- COMMAND ----------

select count(distinct procodet) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_stroke_admissions_op_v1
