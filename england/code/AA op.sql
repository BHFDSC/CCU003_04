...
DROP TABLE dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op_v5

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op_v5 AS 
...
ALTER TABLE dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op_v5 OWNER TO `rmhikmc@ucl.ac.uk`

-- COMMAND ----------

refresh table dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op_v5

-- COMMAND ----------

select * from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op_v5

-- COMMAND ----------

select year(admidate), count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op_v5 group by year(admidate) order by year(admidate)

-- COMMAND ----------

select year(disdate), count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op_v5 group by year(disdate) order by year(disdate)

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op_v5

-- COMMAND ----------

select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op_v5
