...
ALTER TABLE dars_nic_391419_j3w9t_collab.ccu003_04_nh_temp_superspells_base OWNER TO `rmhikmc@ucl.ac.uk`
...
DROP TABLE IF EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op AS 
...
ALTER TABLE dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op OWNER TO `rmhikmc@ucl.ac.uk`

-- COMMAND ----------

select * from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op

-- COMMAND ----------

select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op

-- COMMAND ----------

select * from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_AA_admissions_op where person_id = '09T80C90ZOFDJDD'
