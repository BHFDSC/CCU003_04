...
CREATE WIDGET TEXT ccu003_04_spec DEFAULT 'aa_op'
...
-----------------------------------------------
-- AA procedure episodes
-----------------------------------------------
-- This query returns one row per each AA procedure for each episode - this means there are multiple rows per episode!!!
...
LEFT(code, 3) IN ('L18','L19','L20','L21','L22','L23','L25','L26','L27','L28')
...
DROP TABLE .ccu003_04_kmc_final_AA_admissions_op_v5

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_kmc_final_AA_admissions_op_v5 AS 
...
ALTER TABLE .ccu003_04_kmc_final_AA_admissions_op_v5 OWNER TO `rmhikmc@ucl.ac.uk`

-- COMMAND ----------

refresh table .ccu003_04_kmc_final_AA_admissions_op_v5

-- COMMAND ----------

select * from .ccu003_04_kmc_final_AA_admissions_op_v5

-- COMMAND ----------

select year(admidate), count(*) from .ccu003_04_kmc_final_AA_admissions_op_v5 group by year(admidate) order by year(admidate)

-- COMMAND ----------

select year(disdate), count(*) from .ccu003_04_kmc_final_AA_admissions_op_v5 group by year(disdate) order by year(disdate)

-- COMMAND ----------

select count(*) from .ccu003_04_kmc_final_AA_admissions_op_v5

-- COMMAND ----------

select count(distinct PERSON_ID) from .ccu003_04_kmc_final_AA_admissions_op_v5
