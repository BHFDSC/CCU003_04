...
-- AA ops episodes
-----------------------------------------------
-- This query returns one row per each AA op for each episode - this means there are multiple rows per episode!!!
...
select * from .ccu003_04_nh_temp_final_episodes1 where spell_id = 4915168147
...
ALTER TABLE .ccu003_04_nh_temp_superspells_base OWNER TO `rmhikmc@ucl.ac.uk`
...
DROP TABLE IF EXISTS .ccu003_04_kmc_final_AA_admissions_op

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_kmc_final_AA_admissions_op AS 
...
ALTER TABLE .ccu003_04_kmc_final_AA_admissions_op OWNER TO `rmhikmc@ucl.ac.uk`

-- COMMAND ----------

select * from .ccu003_04_kmc_final_AA_admissions_op

-- COMMAND ----------

select count(*) from .ccu003_04_kmc_final_AA_admissions_op

-- COMMAND ----------

select count(distinct PERSON_ID) from .ccu003_04_kmc_final_AA_admissions_op

-- COMMAND ----------

select * from .ccu003_04_kmc_final_AA_admissions_op where person_id = ''
