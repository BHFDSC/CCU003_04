...
CREATE WIDGET TEXT ccu003_04_spec DEFAULT 'stroke_dx'
...
-----------------------------------------------
-- Stroke diagnosis episodes
-----------------------------------------------
-- This query returns one row per each stroke diagnosis for each episode - this means there are multiple rows per episode!!!
...
LEFT(code, 3) in ('I60','I61','I63','I64','G45')
...
DROP TABLE IF EXISTS .ccu003_04_kmc_final_stroke_admissions_dx_v1

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_kmc_final_stroke_admissions_dx_v1 AS 
...
select * from .ccu003_04_kmc_final_stroke_admissions_dx_v1

-- COMMAND ----------

refresh table .ccu003_04_kmc_final_stroke_admissions_dx

-- COMMAND ----------

select count(*) from .ccu003_04_kmc_final_stroke_admissions_dx

-- COMMAND ----------

select count(*) from .ccu003_04_kmc_final_stroke_admissions_dx_v1

-- COMMAND ----------

select count(distinct SPELL_ID) from .ccu003_04_kmc_final_stroke_admissions_dx

-- COMMAND ----------

select count(distinct SPELL_ID) from .ccu003_04_kmc_final_stroke_admissions_dx_v1

-- COMMAND ----------

select count(distinct PERSON_ID) from .ccu003_04_kmc_final_stroke_admissions_dx

-- COMMAND ----------

select count(distinct PERSON_ID) from .ccu003_04_kmc_final_stroke_admissions_dx_v1
...
select count(distinct procodet) from .ccu003_04_kmc_final_stroke_admissions_dx_v1
