...
DROP TABLE IF EXISTS .ccu003_04_kmc_final_stroke_admissions_dx

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_kmc_final_stroke_admissions_dx AS 
...
select * from .ccu003_04_kmc_final_stroke_admissions_dx

-- COMMAND ----------

select count(*) from .ccu003_04_kmc_final_stroke_admissions_dx where COILING = 1
