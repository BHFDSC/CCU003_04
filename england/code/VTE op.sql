...
-----------------------------------------------
-- PE procedure episodes
-----------------------------------------------
-- This query returns one row per each PE procedure for each episode - this means there are multiple rows per episode!!!
...
( -- need to make a CTE where the dx/op code fields are exploded into rows - then we have one row for each dx or op in each episode.
  ...
  --DIAGS
  --posexplode(array(diag_4_01, 	diag_4_02, 	diag_4_03, 	diag_4_04, 	diag_4_05, 	diag_4_06, 	diag_4_07, 	diag_4_08, 	diag_4_09, 	diag_4_10, 	diag_4_11, 	diag_4_12, 	diag_4_13, 	diag_4_14, 	diag_4_15, 	diag_4_16, 	diag_4_17, 	diag_4_18, 	diag_4_19, 	diag_4_20)) AS (pos_code, code)
...
ALTER TABLE .ccu003_04_nh_temp_superspells_lookup OWNER TO `rmhikmc@ucl.ac.uk`
...
DROP TABLE IF EXISTS .ccu003_04_kmc_final_vte_admissions_op

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_kmc_final_vte_admissions_op AS 
...
ALTER TABLE .ccu003_04_kmc_final_vte_admissions_op OWNER TO `rmhikmc@ucl.ac.uk`

-- COMMAND ----------

select * from .ccu003_04_kmc_final_vte_admissions_op
