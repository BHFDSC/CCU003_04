...
select max(disdate) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_base
...
select year(admidate), count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_temp_episodes_base group by year(admidate) order by year(admidate)
...
refresh table dars_nic_391419_j3w9t_collab.ccu003_04_nh_temp_spells_base9
...
DROP TABLE IF EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_acs_admissions_op

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_acs_admissions_op AS 
...
ALTER TABLE dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_acs_admissions_op OWNER TO `nick.hall@dph.ox.ac.uk`

-- COMMAND ----------

select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_acs_admissions_op

-- COMMAND ----------

select year(admidate), count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_temp_final_episodes1 group by year(admidate) order by year(admidate)

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_acs_admissions_op

-- COMMAND ----------

select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_acs_admissions_op
