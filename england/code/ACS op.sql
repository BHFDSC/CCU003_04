...
select year(admidate), count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_episodes_base group by year(admidate) order by year(admidate)
...
refresh table dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_spells_base
...
select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_superspells_base ORDER BY PERSON_ID, superspellno
...
select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_superspells_base where person_id = 'Q5WLH8FM5UIP66S' order by superspellno
...
refresh table dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_admissions_${ccu003_04_spec}
...
select year(admidate), count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_acs_admissions_op_old group by year(admidate) order by year(admidate)

-- COMMAND ----------

select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_acs_admissions_op_old where spell_id not in (select spell_id from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_admissions_${ccu003_04_spec})

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_admissions_${ccu003_04_spec}

-- COMMAND ----------

select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_nh_final_admissions_${ccu003_04_spec}
