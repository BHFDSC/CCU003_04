...
DROP TABLE IF EXISTS .ccu003_04_kmc_final_PAD_admissions_dx

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_kmc_final_PAD_admissions_dx AS 
...
select * from .ccu003_04_kmc_final_PAD_admissions_dx

-- COMMAND ----------

select count(*) from .ccu003_04_kmc_final_PAD_admissions_dx

-- COMMAND ----------

select count(distinct PERSON_ID) from .ccu003_04_kmc_final_PAD_admissions_dx
