...
DROP TABLE IF EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_dx

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_dx AS 
...
select * from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_dx

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_dx

-- COMMAND ----------

select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_dx
