...
CREATE TABLE IF NOT EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_superspells_base1 AS
...
ALTER TABLE dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_superspells_base1   OWNER TO `rmhikmc@ucl.ac.uk`

-- COMMAND ----------

select * from 
(
select PERSON_ID, count(distinct in_spell_id) as c from dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_superspells_base1 group by person_id --ORDER BY PERSON_ID, count(distinct in_spell_id) desc
)
order by c desc

-- COMMAND ----------

 select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_superspells_base1 where person_id = 'Q5WLH8FM5UIP66S' order by SpellOrder
...
FROM dars_nic_391419_j3w9t_collab.ccu003_04_nh_${ccu003_04_spec}_temp_superspells_base1 WHERE SuperSpell_SpellNo = 1
...
-- MAGIC FROM dars_nic_391419_j3w9t_collab.ccu003_04_nh_{specname}_temp_superspells_base1 AS base INNER JOIN dars_nic_391419_j3w9t_collab.ccu003_04_nh_{specname}_temp_superspells_lookup AS lookup ON base.Out_Spell_ID = lookup.Spell_ID AND base.PERSON_ID = lookup.Person_ID \
...
DROP TABLE IF EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_pad_admissions_dx_v2

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_pad_admissions_dx_v2 AS 
...
ALTER TABLE dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_pad_admissions_dx_v2 OWNER TO `rmhikmc@ucl.ac.uk`

-- COMMAND ----------

select * from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_pad_admissions_dx_v2

-- COMMAND ----------

refresh table dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_pad_admissions_dx_v2

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_pad_admissions_dx_v2
...
select count(distinct SPELL_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_pad_admissions_dx_v2
...
select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_pad_admissions_dx_v2
...
select count(distinct procodet) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_pad_admissions_dx_v2 
