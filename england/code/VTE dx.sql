...
CREATE WIDGET TEXT ccu003_04_spec DEFAULT 'vte_dx'
...
DROP TABLE IF EXISTS .ccu003_04_kmc_final_vte_admissions_dx_v1

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_kmc_final_vte_admissions_dx_v1 AS 
...
ALTER TABLE .ccu003_04_kmc_final_vte_admissions_dx_v1 OWNER TO `rmhikmc@ucl.ac.uk`

-- COMMAND ----------

select * from .ccu003_04_kmc_final_vte_admissions_dx_v1

-- COMMAND ----------

refresh table .ccu003_04_kmc_final_vte_admissions_dx_v1

-- COMMAND ----------

select count(*) from .ccu003_04_kmc_final_vte_admissions_dx_v1

-- COMMAND ----------

select count(distinct SPELL_ID) from .ccu003_04_kmc_final_vte_admissions_dx_v1

-- COMMAND ----------

select count(distinct PERSON_ID) from .ccu003_04_kmc_final_vte_admissions_dx_v1

-- COMMAND ----------

select count(distinct procodet) from .ccu003_04_kmc_final_vte_admissions_dx_v1 
