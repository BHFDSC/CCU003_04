...
select * from .ccu003_04_nh_temp_superspells_base1 where person_id = '6PUZHW64W1HOWSN'
...
DROP TABLE IF EXISTS .ccu003_04_kmc_final_AA_admissions_dx_v1

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_kmc_final_AA_admissions_dx_v1 AS 
...
select * from .ccu003_04_kmc_final_AA_admissions_dx_v1

-- COMMAND ----------

select count(*) from .ccu003_04_kmc_final_AA_admissions_dx_v1

-- COMMAND ----------

select count(distinct PERSON_ID) from .ccu003_04_kmc_final_AA_admissions_dx_v1
