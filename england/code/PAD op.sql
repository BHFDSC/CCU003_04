...
-----------------------------------------------
-- PAD procedures episodes
-----------------------------------------------
-- This query returns one row per each PAD procedures for each episode - this means there are multiple rows per episode!!!
...
select * from .ccu003_04_nh_temp_final_episodes1 where spell_id = 4986343977
...
select * from .ccu003_04_nh_temp_superspells_base1 where person_id = 'EWOABQEARULVUW9'
...
select * from .ccu003_04_nh_temp_final_episodes1 where person_id = 'EWOABQEARULVUW9' order by spell_id, epiorder
...
DROP TABLE IF EXISTS .ccu003_04_kmc_final_PAD_admissions_op

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS .ccu003_04_kmc_final_PAD_admissions_op AS 
...
select * from .ccu003_04_kmc_final_PAD_admissions_op

-- COMMAND ----------

select count(*) from .ccu003_04_kmc_final_PAD_admissions_op

-- COMMAND ----------

select count(distinct PERSON_ID) from .ccu003_04_kmc_final_PAD_admissions_op
