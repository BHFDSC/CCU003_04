...
select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_temp_final_episodes1 where spell_id = 4986343977
...
select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_temp_superspells_base1 where person_id = 'EWOABQEARULVUW9'
...
select * from dars_nic_391419_j3w9t_collab.ccu003_04_nh_temp_final_episodes1 where person_id = 'EWOABQEARULVUW9' order by spell_id, epiorder
...
DROP TABLE IF EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_op

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_op AS 
...
select * from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_op

-- COMMAND ----------

select count(*) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_op

-- COMMAND ----------

select count(distinct PERSON_ID) from dars_nic_391419_j3w9t_collab.ccu003_04_kmc_final_PAD_admissions_op
